...
bool ns_perf_has_core_counters(void) { return true; }

bool ns_perf_has_cache_counters(void) {
#if defined(AM_PART_APOLLO3) || defined(AM_PART_APOLLO3P) || defined(AM_PART_APOLLO4B) || defined(AM_PART_APOLLO4P) || defined(AM_PART_APOLLO4L)
    return true;
#else
    return false;
#endif
